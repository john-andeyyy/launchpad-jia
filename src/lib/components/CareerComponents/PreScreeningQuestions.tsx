...
export default function PreScreeningQuestions({
    ...
    return (
        <div className="flex flex-col gap-4 mt-4 pt-4 border-t border-[#E9EAEB]">
...
function QuestionCard({
    ...
    return (
        ...
        >
            ...
            <div
                className={`flex-1 bg-white rounded-lg border overflow-hidden transition-all ${
                    hasError ? "border-red-500" : "border-[#E9EAEB]"
