    ...
    <div className={hasError ? "border-2 border-[#DC2626] rounded-lg overflow-hidden" : ""}>
      <div
        ...
        style={{
          height: "300px",
          overflowY: "auto",
          borderTopLeftRadius: hasError ? "4px" : "0",
          borderTopRightRadius: hasError ? "4px" : "0",
          border: hasError ? "none" : btnBorder ? "1px solid #CCCCCC !important" : "none",
          borderBottomRightRadius: btnBorder ? "4px" : "0",
          borderBottomLeftRadius: btnBorder ? "4px" : "0",
          padding: "12px",
          lineHeight: "1.5",
          position: "relative",
        }}
      ...
      <div style={{
        border: btnBorder ? "1px solid #CCCCCC " : "none",
        borderTop: btnBorder ? "none" : "none",
